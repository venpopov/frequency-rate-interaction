...
all_words<-read.csv('expfiles/materials/SUBTLEX_all_words.csv', stringsAsFactors = FALSE)
...
write.csv(stim,'expfiles/materials/exp6_mixed_speed_freq_loc_Oct2018/words.csv', row.names = FALSE)
