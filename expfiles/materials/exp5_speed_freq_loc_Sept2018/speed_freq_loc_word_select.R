...
all_words<-read.csv('expfiles/materials/exp5_speed_freq_loc_Sept2018/SUBTLEX_all_words.csv', stringsAsFactors = FALSE)
...
write.csv(stim,'expfiles/materials/exp5_speed_freq_loc_Sept2018/words.csv', row.names = FALSE)
